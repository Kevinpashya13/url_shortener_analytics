...
function SplineUrlClicksChart({ clicksByDay }) {
    ...
    <div className="spline-chart-wrap" ref={containerRef} onMouseMove={handleMouseMove} onMouseLeave={() => setHoveredIdx(null)}>
      <div className="spline-header">
        ...
        <div className="spline-legend">
          <span className="legend-item"><span className="legend-dot blue" /> Daily Traffic</span>
        </div>
      </div>
      ...
      <svg width="100%" height={H} viewBox={`0 0 ${W} ${H}`} style={{ overflow: 'visible' }}>
        ...
        {/* Smooth Curved Line */}
        <path d={createCurvedPath()} fill="none" stroke="#3b82f6" strokeWidth="3.5" strokeLinecap="round" />

        {/* Active hover dot */}
        {activeIndex !== null && days[activeIndex] && (
          <circle cx={getX(activeIndex)} cy={getY(days[activeIndex].count)} r="6" fill="#3b82f6" stroke="#fff" strokeWidth="2.5" />
        )}
      </svg>
      ...
      {activeIndex !== null && days[activeIndex] && (
        <div
          ...
          style={{
            ...
            top: `${Math.max(getY(days[activeIndex].count) - 45, 10)}px`,
          }}
        >
          ...
          <div className="tooltip-val blue-text">
            {days[activeIndex].count.toLocaleString()} {days[activeIndex].count === 1 ? 'click' : 'clicks'}
          </div>
        </div>
      )}
    </div>
    ...
    <div className="analytics-screen">
      ...
      <div className="dash-grid-layout">
        ...
        <div className="dash-col-left">
          ...
          {/* Spline Chart */}
          <div className="dash-box">
            <SplineUrlClicksChart clicksByDay={data.clicksByDay} />
          </div>
